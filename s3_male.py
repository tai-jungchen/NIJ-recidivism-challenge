...
def main():
    ########## dataset ##########
    df_global = pd.read_pickle("Processed_Data/Global_MI_multi_cat_year12_2.pkl")
    ...
    df_global = df_global[df_global['Recidivism_Arrest_Year1'] != 1]  # discard year 1 recidivism subject
